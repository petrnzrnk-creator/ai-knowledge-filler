...
''')
    ...
    def test_generate_file_via_api(self, mock_anthropic_client):
        ...
        response = client.messages.create(
            ...
            max_tokens=4096,
            messages=[
                {"role": "user", "content": "Create a guide on Docker"}
            ]
        )
    ...
    def test_streaming_response(self, mock_anthropic_client):
        ...
        mock_anthropic_client.return_value.messages.stream.return_value.__enter__.return_value = mock_stream
...
'''
    ...
    def test_generate_and_save_file(self, mock_file_generator):
        ...
        try:
            result = mock_file_generator(
                "Create a guide on API security",
                output_path
            )
